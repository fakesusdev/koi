...
paperjar="$basedir/Koi-Server/target/koi-$mcver.jar"
...
cp "$basedir/Paperclip/assembly/target/paperclip-${mcver}.jar" "$basedir/koi-paperclip.jar"

echo ""
echo ""
echo ""
echo "Build success!"
echo "Copied final jar to $(cd "$basedir" && pwd -P)/koi-paperclip.jar"
) || exit 1
